...
//typedef struct tagNM_GRIDVIEWKEYDOWN {
//  NMHDR hdr;
//  WORD  wVKey;
//  UINT  flags;
//} NM_GRIDVIEWKEYDOWN, *LPNM_GRIDVIEWKEYDOWN;
...
#define	GVN_BEGINTRACK			HDN_BEGINTRACK
#define	GVN_ENDTRACK			HDN_ENDTRACK
#define	GVN_ITEMKEYDOWN			LVN_KEYDOWN
#define	GVN_ITEMKEYUP			LVN_KEYDOWN + 1
...
public:
    ...
    void SetVirtualMode(BOOL bVirtual, BOOL bDeleteColumns = TRUE);
	...
	void SetEditModeOnKeyDown(BOOL bEdit = TRUE)  { m_bEditModeOnKeyDown = bEdit;}
    ...
    void SetAutoSizeStyle(int nStyle = GVS_BOTH, BOOL bFastMethod = FALSE);
...
public:
    ...
    BOOL DeleteAllItems(BOOL bDeleteColumns = TRUE);

	virtual void ClearCells(CCellRange Selection);
...
///////////////////////////////////////////////////////////////////////////////////
 public:
	...
	void SetSelectedRows(int nMinRow, int nMaxRow);
...
protected:
    ...
    LRESULT SendMessageToParent(int nRow, int nCol, int nMessage, DWORD dwParam = 0) const;
...
protected:
	...
	BOOL		m_bAutoSizeColumnFast;
	BOOL		m_bEditModeOnKeyDown;
